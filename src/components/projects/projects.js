          ...
          <div className="projects-wrapper">
            ...
            <div className="portfolio-list">
              ...
              <div className="mix project-item javascript">
                ...
                <span className="released-date">Personal project - 2019</span>
              </div>
              <div className="mix project-item javascript react">
              ...
              <div className="mix project-item javascript react">
                ...
                <span className="released-date">Personal project - 2018</span>
              </div>
              ...
              <div className="mix project-item cms bootstrap wordpress disabled">
                ...
                <span className="released-date"><i className="fas fa-sunset"></i>Personal project :- 2015 - 2017</span>
              </div>
              ...
              <div className="mix project-item cms javascript bootstrap disabled wordpress cssfw">
                ...
                <span className="released-date"><i className="fas fa-sunset"></i>Personal project :- 2013 - 2017</span>
              </div>
